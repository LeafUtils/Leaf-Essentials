...
(function (root, factory) {
    ...
    return (function () {
      ...
      Loki.prototype.autosaveEnable = function (options, callback) {
        ...
        this.autosaveHandle = system.runInterval(function autosaveHandleInterval() {
      ...
      Collection.prototype.setTTL = function (age, interval) {
        if (age < 0) {
          ...
          this.ttl.daemon = system.runInterval(this.ttlDaemonFuncGen(), (Math.floor(interval / 1000)) * 20);
        }
      };
